...
def main():
    ...
    try:
        for nome_comp, url in COMPETICOES.items():
            ...
            # Ajusta a URL para o formato /calendario/ do Superscore
            ...
            for idx in range(total_elementos):
                try:
                    ...
                    # ----------------------------------------------------------
                    # FASE 1: ANÁLISE DE MERCADOS DE RECORRÊNCIA (Superscore / Flashscore H2H)
                    # ----------------------------------------------------------
                    # Mantém a URL base do Flashscore apenas para o motor de H2H/Odds se necessário, 
                    # mas os links de estatística finais passam a apontar para o Superscore.
                    ...
                    # ----------------------------------------------------------
                    # FASE 2: RASPAGEM ESTATÍSTICA COLETIVA (Agora sem trava de liga)
                    # ----------------------------------------------------------
                    print(f"     📊 [FASE 2] Buscando Estatísticas Coletivas no Superscore para {nome_comp}...")
                    try:
                    ...
                    # Atualização do link de estatísticas para o Superscore
                    url_h2h_final = f"https://www.superscore.com/jogo/{id_jogo}/#/resumo-de-jogo"
