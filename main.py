...
def executar():
    ...
    # AJUSTE DOS LINKS CONFORME O PADRÃO: /leagues/pais-nome-liga
    ligas_config = {
        ...
        try:
            ...
            for m in matches:
                ...
                if opcoes:
                    ...
                    # Link corrigido com /leagues/ e sem espaços
                    link = f"https://www.adamchoi.co.uk/leagues/{l_slug}".strip()
