...
def verificar_chance_dupla(s):
    ...
    # ----------------------------------------------------------
    condicao_1x = (m_sem_derrota_casa >= 4 and v_derrotas_fora >= 4) and (v_sofridos_fora >= 7)
    ...
    # ----------------------------------------------------------
    condicao_x2 = (v_sem_derrota_fora >= 4 and m_derrotas_casa >= 4) and (m_sofridos_casa >= 7)
