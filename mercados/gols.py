"""
REGRAS DE GOLS - VERSÃO PURA E DIRETA
- Over: Mínimo 4/5 (>= 80%), apenas o maior (+2.5 -> +1.5 -> +0.5)
- Under: Mínimo 4/5 (>= 80%), apenas o menor (-3.5 -> -4.5 -> -5.5)
- Regra de Ouro: Ou Over, ou Under (prioridade para Over se ambos existirem, ou siga a preferência)
"""
...
def verificar_gols(s):
    ...
    # ==========================================================
    # APLICAÇÃO DAS REGRAS DE SELEÇÃO ÚNICA E EXCLUSÃO MÚTUA
    # ==========================================================
    
    # Se houver over válido, pega o maior (o primeiro da lista: +2.5 > +1.5 > +0.5)
    if overs_aprovados:
        return [overs_aprovados[0]]
    
    # Se não tem over mas tem under, pega o menor (o primeiro da lista: -3.5 > -4.5 > -5.5)
